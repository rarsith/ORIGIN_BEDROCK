...
start_button = tk.Button(root, text="Start", command=start_function, width=15, bg='#10AC84', fg='white', height=5,
                         font=label_font)
start_button.pack()

stop_button = tk.Button(root, text="Stop", command=stop_function, width=15, bg='#EE5253', fg='white', height=5,
                        font=label_font)
stop_button.pack()
