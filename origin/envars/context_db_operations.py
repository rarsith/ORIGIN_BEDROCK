...
class OriginDatabaseHandler:
    ...
    def get_current_db_asset_version(self,  db_doc_obj=None):
        ...
        Returns: database document of the current db_asset version that has one of the approved class statuses
