...
class OriginContext:
    ...
    origin_project_work: str = None
    origin_project_control: str = None
    origin_project_publishes: str = None
    origin_entity_name: str = None
    origin_task: str = None
    origin_hierarchy_path: str = None


class OriginEnvar:

    def __init__(self):
        self.context_data = OriginContext()
    ...
    @property
    def show_name(self):
        return self.context_data.origin_project

    @show_name.setter
    def show_name(self, project):
        self.context_data.origin_project = project

    @property
    def project_publishes(self):
        return self.context_data.origin_project_publishes

    @project_publishes.setter
    def project_publishes(self, proj_pub):
        self.context_data.origin_project_publishes = proj_pub

    @property
    def project_work(self):
        return self.context_data.origin_project_work

    @project_work.setter
    def project_work(self, proj_work):
        self.context_data.origin_project_work = proj_work

    @property
    def project_control(self):
        return self.context_data.origin_project_control

    @project_control.setter
    def project_control(self, proj_ctrl):
        self.context_data.origin_project_control = proj_ctrl

    @property
    def origin_path_hierarchy(self):
        return self.context_data.origin_hierarchy_path
    ...
    def origin_path_hierarchy(self, selection):
        ...
        self.context_data.origin_hierarchy_path = hierarchy

    @property
    def entry_name(self):
        return self.context_data.origin_entity_name

    @entry_name.setter
    def entry_name(self, entity):
        self.context_data.origin_entity_name = entity

    @property
    def task_name(self):
        return self.context_data.origin_task

    @task_name.setter
    def task_name(self, task):
        self.context_data.origin_task = task
    ...
    def resolve_db_filter(self):
        current_envars = {"show_name": self.context_data.origin_project,
                          "origin_db_path": self.context_data.origin_hierarchy_path,
                          "entry_name": self.context_data.origin_entity_name,
                          "task_name": self.context_data.origin_task}
...
if __name__ == "__main__":
    ...
    context.show_name = "Green"
    context.entry_name = "0200"

    context.origin_path_hierarchy = selection_list
    print(context.origin_path_hierarchy)
    full_con = context.full_context()
    print(full_con.origin_entity_name)
    xxx =context.resolve_context_to_base()
    print(xxx)
