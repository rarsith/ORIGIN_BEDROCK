...
class CreateGroupUI(QtWidgets.QDialog):
    ...
    def create_layout(self):
        ...
        form_layout.addRow("Group Path: ", self.show_name_le)
        form_layout.addRow("Group Name:", self.group_name_le)
        form_layout.addRow("Content Type:", self.category_cb)
    ...
    def db_commit(self):
        ...
        Create().group(name=asset_name, task_schema=self.user_data)
