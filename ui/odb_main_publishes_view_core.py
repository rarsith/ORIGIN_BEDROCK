...
# PublishSlotsWidget -- START
    ...
    def populate_publishes(self, name, row):
        ...
        # self.status_cb.setFixedHeight(20)
        self.status_cb.setSizePolicy(QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Expanding)
        layout.addWidget(self.status_cb, alignment=QtCore.Qt.AlignCenter)
        ...
        self.publish_view_tw.setItem(row, 0, QtWidgets.QTableWidgetItem('---'))
        self.publish_view_tw.setItem(row, 1, QtWidgets.QTableWidgetItem(self.get_publish_name))
        self.publish_view_tw.setItem(row, 2, QtWidgets.QTableWidgetItem(self.get_publish_version))
        self.publish_view_tw.setCellWidget(row, 3, self.status_cb)
        self.publish_view_tw.setItem(row, 4, QtWidgets.QTableWidgetItem('type'))
        self.publish_view_tw.setItem(row, 5, QtWidgets.QTableWidgetItem('task_type'))
        # self.publish_view_tw.setItem(row, 2, QtWidgets.QTableWidgetItem(self.get_publish_task))

        self.publish_view_tw.setItem(row, 6, QtWidgets.QTableWidgetItem(self.get_publish_user))
        self.publish_view_tw.setItem(row, 7, QtWidgets.QTableWidgetItem(str(self.get_publish_date)))
        self.publish_view_tw.setItem(row, 8, QtWidgets.QTableWidgetItem(str(self.get_publish_time)))
        self.publish_view_tw.setItem(row, 9, QtWidgets.QTableWidgetItem('BLA'))
        self.publish_view_tw.setItem(row, 10, QtWidgets.QTableWidgetItem(str(self.get_id)))
