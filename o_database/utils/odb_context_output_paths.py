...
class OutputPaths:
    def __init__(self, version="", pub_slot="", output_file_name="default", context=None):
    ...
    def base_path(self):
        path_entities = [self.context.show_name,
    ...
    def main_publish_path(self):
        ...
        main_pub_elements = ["publishes", self.version, self.pub_slot, self.output_file_name]
