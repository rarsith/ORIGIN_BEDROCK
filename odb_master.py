...
from ui.odb_task_viewer_core import TaskViewerCore
...
class OriginControlCenterUI(QtWidgets.QWidget):
    ...
    def create_widgets(self):
        ...
        # self.middle_tabmenu_tab.setMinimumWidth(850)
        # self.middle_tabmenu_tab.setMaximumWidth(1170)
        ...
        self.details_tabmenu_tab.setMinimumWidth(300)
        self.details_tabmenu_tab.setMaximumWidth(450)
    ...
    def create_layout(self):
        ...
        self.horizontal_splitter.addWidget(self.show_view_twd)
        # views_layout.addWidget(self.show_view_twd)

        self.horizontal_splitter.addWidget(self.tasks_view_lwd)
        # views_layout.addWidget(self.tasks_view_lwd)

        self.horizontal_splitter.addWidget(self.middle_tabmenu_tab)
        # views_layout.addWidget(self.middle_tabmenu_tab)

        self.horizontal_splitter.addWidget(self.details_tabmenu_tab)
    ...
    def get_selected_type(self):
        ...
        if entry_selected:
            get_selected_objects_type = Query().curr_asset().entity_type
