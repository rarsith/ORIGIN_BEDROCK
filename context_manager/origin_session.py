...
origin_root = r"C:\Users\arsithra\PycharmProjects\ORIGIN_BEDROCK"
...
class ContextHandler:
    ...
    def resolve_to_full_context(self):
        ...
        """
        origin_context = ".".join(filter(None, [self.show_name, self.origin_path_hierarchy, self.entry_name, self.task_name]))
...
context_session = ContextHandler()
...
if __name__ == "__main__":
    ...
    context_session.show_name = "New_Era"
    context_session.origin_path_hierarchy = db_path
    context_session.entry_name = "hulk"
    context_session.task_name = "modeling"

    print(context_session.show_name)
    print(context_session.origin_path_hierarchy)
    print(context_session.entry_name)
    print(context_session.task_name)

    print(context_session.session_context.__dict__)
    print(os.getenv("BASE_APP_CURRENT_SESSION"))

    context_session.end_session()
