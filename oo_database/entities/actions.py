...
class Query:
    ...
    def entity_by_id(self, entity_id):
        return Entity(entity_id=entity_id, operation=DBFind, db_operation="attr_values")

    def curr_entity(self):
        return Entity(entity_id=DbIds.curr_entry_id(), operation=DBFind, db_operation="attr_values")

    def curr_project(self):
        return Project(entity_id=DbIds().curr_project_id(), operation=DBFind, db_operation="attr_values")

    def projects(self):
        return Projects(operation=DBFind, db_operation="attr_values")

    def curr_asset(self):
        return Assets(entity_id=DbIds.curr_entry_id(), operation=DBFind, db_operation="attr_values")

    def curr_task(self):
        return Tasks(entity_id=DbIds.curr_entry_id(), operation=DBFind, db_operation="attr_values")
...
class Add:
    ...
    def entity_by_id(self, entity_id):
        return Entity(entity_id=entity_id, operation=DBAdd, db_operation="value_to_field")

    def curr_project(self):
        return Project(entity_id=DbIds().curr_project_id(), operation=DBAdd, db_operation="value_to_field")

    # def all_shows(self):
    #     return Projects()

    def curr_asset(self):
        return Assets(entity_id=DbIds.curr_entry_id(), operation=DBAdd, db_operation="value_to_field")

    def curr_task(self):
        return Tasks(entity_id=DbIds.curr_entry_id(), operation=DBAdd, db_operation="value_to_field")
...
class Set:
    ...
    def entity_by_id(self, entity_id):
        return Entity(entity_id=entity_id, operation=DBSet, db_operation="attribute_value")
    ...
    def curr_asset(self):
        return Assets(entity_id=DbIds.curr_entry_id(), operation=DBSet, db_operation="attribute_value")

    def curr_task(self):
        return Tasks(entity_id=DbIds.curr_entry_id(), operation=DBSet, db_operation="attribute_value")
...
class Remove:
    ...
    def entity_by_id(self, entity_id):
        return Entity(entity_id=entity_id, operation=DBRemove, db_operation="attribute_value")

    def curr_project(self):
        return Project(entity_id=DbIds().curr_project_id(), operation=DBRemove, db_operation="attribute_value")

    # def all_shows(self):
    #     return Projects(operation=Remove, db_operation="attribute_value")

    def curr_asset(self):
        return Assets(entity_id=DbIds.curr_entry_id(), operation=DBRemove, db_operation="attribute_value")


    def curr_task(self):
        return Tasks(entity_id=DbIds.curr_entry_id(), operation=DBRemove, db_operation="attribute_value")
...
if __name__ == "__main__":
    ...
    operations_list = [{'tasks.concept.status': 'IN PROGRESS'}]
